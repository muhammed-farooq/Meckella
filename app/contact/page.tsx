  ...
  return (
    <div className="w-full flex flex-col min-h-screen bg-background">
      <section className="pt-32 pb-16 px-[20px] lg:px-[70px] max-w-7xl mx-auto w-full text-center">
        <h1 className="font-serif text-5xl md:text-6xl text-foreground mb-6">Contact the House</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24">
          ...
          <div className="flex flex-col gap-16 justify-center">
            <div className="flex flex-col gap-6">
              <h3 className="font-serif text-2xl text-foreground">Atelier & Care</h3>
            ...
            <div className="flex flex-col gap-6">
              <h3 className="font-serif text-2xl text-foreground">Social Presence</h3>
              <div className="flex gap-8">
                <a href="#" className="text-[#A1A1A1] hover:text-accent-gold transition-colors uppercase tracking-widest text-sm">Instagram</a>
                <a href="#" className="text-[#A1A1A1] hover:text-accent-gold transition-colors uppercase tracking-widest text-sm">Facebook</a>
                <a href="#" className="text-[#A1A1A1] hover:text-accent-gold transition-colors uppercase tracking-widest text-sm">Pinterest</a>
              </div>
            </div>
          </div>
        </div>
