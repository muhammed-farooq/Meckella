...
export default function Error({
  ...
  return (
    <div className="w-full min-h-[70vh] bg-[#0B0B0B] text-[#EDEDED] flex flex-col items-center justify-center relative px-[20px] overflow-hidden">
      ...
      <div className="relative z-10 text-center flex flex-col items-center max-w-xl">
        <span className="text-[#C9A96E] font-serif italic text-6xl md:text-8xl mb-6 block tracking-widest opacity-80 select-none">
          Oops
        </span>
