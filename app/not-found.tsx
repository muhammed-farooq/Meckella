...
export default function NotFound() {
  return (
    <div className="w-full min-h-screen bg-[#0B0B0B] text-[#EDEDED] flex flex-col items-center justify-center relative px-[20px] overflow-hidden">
      ...
      <div className="relative z-10 text-center flex flex-col items-center max-w-xl">
        <span className="text-[#C9A96E] font-serif italic text-7xl md:text-9xl mb-6 block tracking-widest opacity-80 select-none">
          404
        </span>
        
        <h1 className="font-serif text-3xl md:text-4xl text-[#EDEDED] uppercase tracking-[0.2em] mb-6">
          Lost in the Scent
        </h1>
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          ...
          <Link href="/products">
            <Button variant="outline" className="w-full sm:w-auto uppercase tracking-widest font-sans px-10 py-5 rounded-none border-white/20 text-[#EDEDED] hover:bg-white hover:text-black transition-all duration-300">
              Explore Collection
            </Button>
          </Link>
        </div>
