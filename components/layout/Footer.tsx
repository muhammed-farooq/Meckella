...
export function Footer() {
  return (
    <footer className="border-t border-white/5 bg-[#0B0B0B] py-20 mt-auto">
      <div className="max-w-7xl mx-auto px-[20px] lg:px-[70px] grid grid-cols-1 md:grid-cols-3 gap-12 text-[#A1A1A1]">
        <div>
          <h3 className="font-serif text-2xl text-[#EDEDED] uppercase tracking-widest mb-6">Meckella</h3>
        ...
        <div>
          <h4 className="font-sans text-sm uppercase tracking-widest text-[#EDEDED] mb-6">Explore</h4>
        ...
        <div>
          <h4 className="font-sans text-sm uppercase tracking-widest text-[#EDEDED] mb-6">Connect</h4>
          <ul className="space-y-4 text-sm">
      ...
      <div className="max-w-7xl mx-auto px-[20px] lg:px-[70px] mt-20 pt-8 border-t border-white/5 text-xs flex flex-col md:flex-row justify-between items-center text-center md:text-left">
