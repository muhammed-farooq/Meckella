  ...
  return (
    <div id="how-to-use" className="w-full bg-[#0f0f0f] border-t border-white/5 py-24">
      <div className="max-w-7xl mx-auto px-[20px] lg:px-[70px] grid grid-cols-1 md:grid-cols-2 gap-16 lg:gap-24">
        ...
        >
          <div className="mb-4">
            <h3 className="font-serif text-3xl text-[#EDEDED] mb-4">The Meckella Standard</h3>
          ...
          <div className="space-y-10">
            ...
            <div className="flex flex-col md:flex-row items-center md:items-center gap-6 group">
              ...
              <div>
                <h4 className="text-[#EDEDED] uppercase tracking-[0.15em] text-sm font-semibold mb-1">Bottled In India</h4>
            ...
            <div className="flex flex-col md:flex-row items-center md:items-center gap-6 group">
              ...
              <div>
                <h4 className="text-[#EDEDED] uppercase tracking-[0.15em] text-sm font-semibold mb-1">Imported From France</h4>
            ...
            {/* Long Lasting */}
            <div className="flex flex-col md:flex-row items-center md:items-center gap-6 group">
              <div className="w-16 h-16 rounded-full bg-[#1A1A1A] border border-[#333] flex items-center justify-center group-hover:border-[#C9A96E] transition-colors duration-500 text-[#EDEDED]">
                <Clock className="w-6 h-6" />
              </div>
              <div>
                <h4 className="text-[#EDEDED] uppercase tracking-[0.15em] text-sm font-semibold mb-1">Up To 8h+ Longevity</h4>
        ...
        >
          ...
          <h3 className="font-serif text-3xl text-[#EDEDED] mb-8">The Ritual of Application</h3>
          
          <div className="space-y-8 relative z-10">
            <div className="flex gap-4">
               <div className="mt-1 text-[#C9A96E]">
                 <MapPin className="w-5 h-5" />
               </div>
               <div>
                 <h4 className="text-[#EDEDED] tracking-wider uppercase text-sm mb-2">Pulse Points</h4>
            ...
            <div className="flex gap-4">
               ...
               <div>
                 <h4 className="text-[#EDEDED] tracking-wider uppercase text-sm mb-2">Do Not Rub</h4>
            ...
            <div className="flex gap-4">
               ...
               <div>
                 <h4 className="text-[#EDEDED] tracking-wider uppercase text-sm mb-2">The Scent Cloud</h4>
